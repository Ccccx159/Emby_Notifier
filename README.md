...
| 版本 | 日期 | 修订说明 |
| ----- | ----- | ----- |
| Pre v3.0.1 | 2024.08.02 | <li>1. 去除企业微信"推送用户"参数的校验，默认推送给虽有用户；</li><li>2. 修复测试消息推送失败的问题</li><li>3. 新增 aarch64 dockerfile 支持</li>|
| Pre v3.0.0 | 2024.07.29 | <li>1. 新增企业微信支持；</li>|
